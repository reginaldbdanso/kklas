...
const Images = ({ onBack }) => {
  ...
  // If a subject is selected, show the SubjectImages component
  if (selectedSubject) {
    return (
      <SubjectImages subject={selectedSubject} onBack={handleBackToSubjects} />
    );
  }
  ...
  return (
    <div className="ebooks-container">
      ...
      <div className="ebooks-header">
        ...
        <h1 className="ebooks-title">Images</h1>
      </div>
